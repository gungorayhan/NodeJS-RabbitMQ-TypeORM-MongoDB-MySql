...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect("amqp://localhost:5672", function (error0, connection) {
        ...
        connection.createChanel(function (error1, channel) {
            if (error1) {
                throw error1;
            }
            var app = express();
            ...
            app.post("/api/products", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            result = _a.sent();
                            return [4 /*yield*/, channel.sendToQueue('product_created', Buffer.from(JSON.stringify(result)))];
                        case 3:
                            _a.sent();
            ...
            app.put("/api/products/:id/like", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var product, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 2:
                            result = _a.sent();
                            return [4 /*yield*/, channel.sendToQueue('product_updated', Buffer.from(JSON.stringify(result)))];
                        case 3:
                            _a.sent();
                            return [2 /*return*/, res.send(result)];
                    }
